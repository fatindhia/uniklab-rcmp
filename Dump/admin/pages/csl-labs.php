...
$tableBookings = array_values(array_filter($BOOKINGS, fn($b) => $b['lab_type'] === 'csl'));
$tableId       = 'cslTable';
$showType      = false;

$cslLabs = array_values(array_filter($LABS, fn($l) => $l['type'] === 'csl'));
?>
...
<div class="listpage">
  ...
  <div class="page-hero">
    <div class="page-hero-text">
      <span class="page-hero-eyebrow">🧪 CSL</span>
      <h1>CSL Labs</h1>
      <p>Bookings and facility status for Clinical Skills Laboratory rooms in CSL1 and CSL2.</p>
    </div>
    <div class="page-hero-side">
      <span class="page-hero-badge">🧪 <?= count($cslLabs) ?> Labs</span>
      <span class="page-hero-badge"><?= count($tableBookings) ?> Bookings</span>
    </div>
  </div>

  <!-- ── Lab cards ── -->
  <div class="lab-mini-grid" style="--lab-accent:#5d7c86;">
    <?php foreach ($cslLabs as $lab): ?>
    <div class="lab-mini">
  ...
  <div class="card">
    <div class="card-header">
      <span class="card-title">🧪 CSL Lab Bookings</span>
